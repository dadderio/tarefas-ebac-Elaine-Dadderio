package br.com.dadderio.dao.generic.jdbc.dao;

import br.com.dadderio.dao.generic.jdbc.ConnectionFactory;
...
public class ClienteDAO implements IClienteDAO{
    ...
    public Cliente buscar(String codigo) throws Exception {
        Connection connection = null;
        PreparedStatement stm = null;
        ResultSet rs = null; /*retorno do banco de dados onde tem a informação*/
